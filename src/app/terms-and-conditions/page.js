    ...
    <section className="bg-[#FAFAFA] min-h-screen py-12 px-6 sm:px-10 lg:px-20 xl:px-32 overflow-hidden">
      <div className="max-w-5xl mx-auto bg-white shadow-md rounded-2xl p-6 sm:p-10 lg:p-12 border border-gray-100">
        ...
        <div className="space-y-6 text-[#494848] leading-relaxed text-sm sm:text-base">
          ...
          <p>Welcome to Mahesh Wellness and Nutrition!</p> 

          <p>
            These terms and conditions outline the rules and regulations for the use
            of Mahesh Wellness and Nutrition&apos;s website, located at {" "}
            <a
          ...
          <p>
            ...
            conditions. Do not continue to use Mahesh Wellness and Nutrition if you do not agree to
...
{/* change */}
          <p>
            ...
            &quot;We&quot;, &quot;Our&quot;, and &quot;Us&quot; refer to Mahesh Wellness and Nutrition
...
{/* change */}
          <p>
            We employ the use of cookies. By accessing Mahesh Wellness and Nutrition, you agree to
            use cookies in accordance with Mahesh Wellness and Nutrition&apos;s Privacy Policy.
          </p>
...
{/* change */}
          <p>
            Unless otherwise stated, Mahesh Wellness and Nutrition and/or its licensors own the
            intellectual property rights for all material on Nutri Health. All
            intellectual property rights are reserved. You may access this from
            Mahesh Wellness and Nutrition for your own personal use subject to the restrictions set
            in these terms and conditions.
          </p>
{/* change */}
          <p>You must not:</p>
          <ul className="list-disc list-inside space-y-1">
            <li>Republish material from Mahesh Wellness and Nutrition;</li>
            <li>Sell, rent, or sub-license material from Mahesh Wellness and Nutrition;</li>
            <li>Reproduce, duplicate, or copy material from Mahesh Wellness and Nutrition;</li>
            <li>Redistribute content from Mahesh Wellness and Nutrition.</li>
          </ul>
...
{/* change */}
          <p>
            ...
            exchange opinions and information in certain areas of the website. Mahesh Wellness and Nutrition does not filter, edit, publish, or review Comments prior to their
            presence on the website. Comments do not reflect the views or opinions
            of Mahesh Wellness and Nutrition, its agents, and/or affiliates. Comments reflect the
            views and opinions of the person who posts them. To the extent permitted
            by applicable law, Mahesh Wellness and Nutrition shall not be liable for the Comments or
...
{/* change */}
          <p>
            Mahesh Wellness and Nutrition reserves the right to monitor all Comments and to remove
...
{/* change */}
          <p>
            You hereby grant Mahesh Wellness and Nutrition a non-exclusive license to use, reproduce,
          ...
          <p>
            ...
            the hyperlink compensates the absence of Mahesh Wellness and Nutrition; and (d) the link
...
{/* change */}
          <p>
            No use of Mahesh Wellness and Nutrition&apos;s logo or other artwork will be allowed for
